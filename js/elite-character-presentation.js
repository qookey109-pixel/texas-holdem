...
(() => {
  ...
  loadOnce(
    ...
    "js/elite-character-presentation-v2.js?v=runtime-20260821-r1",
    "eliteCharacterPresentationV2",
  );
  loadOnce(
    'script[data-elite-character-progress-fix]',
    "js/elite-character-progress-fix.js?v=runtime-20260821-r1",
    "eliteCharacterProgressFix",
  );
  loadOnce(
    'script[data-ai-tier-boss-system]',
    "js/ai-tier-boss-system.js?v=runtime-20260821-r1",
    "aiTierBossSystem",
  );
  loadOnce(
    'script[data-fair-boss-core-guard]',
    "js/fair-boss-core-guard.js?v=runtime-20260821-r1",
    "fairBossCoreGuard",
  );
  loadOnce(
    'script[data-ai-action-memory]',
    "js/ai-action-memory-v1.js?v=runtime-20260821-r1",
    "aiActionMemory",
  );
  loadOnce(
    'script[data-ai-range-tools]',
    "js/ai-range-tools-v1.js?v=runtime-20260821-r1",
    "aiRangeTools",
  );
  loadOnce(
    'script[data-ai-range-weight]',
    "js/ai-range-weight-v1.js?v=runtime-20260821-r1",
    "aiRangeWeight",
  );
  loadOnce(
    'script[data-ai-character-strategies]',
    "js/ai-character-strategies-v1.js?v=runtime-20260821-r1",
    "aiCharacterStrategies",
  );
  loadOnce(
    'script[data-ai-opening-strategies-v2-3]',
    "js/ai-opening-strategies-v2-3.js?v=runtime-20260821-r1",
    "aiOpeningStrategiesV23",
  );
  loadOnce(
    'script[data-ai-character-strategies-v1-1]',
    "js/ai-character-strategies-v1-1.js?v=runtime-20260821-r1",
    "aiCharacterStrategiesV11",
  );
  loadOnce(
    'script[data-ai-preflop-range-engine]',
    "js/ai-preflop-range-engine-v1.js?v=runtime-20260821-r1",
    "aiPreflopRangeEngine",
  );
  loadOnce(
    'script[data-ai-character-strategies-v1-2]',
    "js/ai-character-strategies-v1-2.js?v=runtime-20260821-r1",
    "aiCharacterStrategiesV12",
  );
  loadOnce(
    'script[data-ai-player-model]',
    "js/ai-player-model-v1.js?v=runtime-20260821-r1",
    "aiPlayerModel",
  );
  loadOnce(
    'script[data-ai-player-model-memory]',
    "js/ai-player-model-memory-v1.js?v=runtime-20260821-r1",
    "aiPlayerModelMemory",
  );
  loadOnce(
    'script[data-ai-character-strategies-v1-3]',
    "js/ai-character-strategies-v1-3.js?v=runtime-20260821-r1",
    "aiCharacterStrategiesV13",
  );
  loadOnce(
    'script[data-ai-multiway-range-model]',
    "js/ai-multiway-range-model-v1.js?v=runtime-20260821-r1",
    "aiMultiwayRangeModel",
  );
  loadOnce(
    'script[data-ai-character-strategies-v1-5]',
    "js/ai-character-strategies-v1-5.js?v=runtime-20260821-r1",
    "aiCharacterStrategiesV15",
  );
  loadOnce(
    'script[data-ai-range-decision-v2-4]',
    "js/ai-range-decision-integration-v2-4.js?v=runtime-20260821-r1",
    "aiRangeDecisionV24",
  );
  loadOnce(
    'script[data-ai-middle-range-decision-v2-6]',
    "js/ai-middle-range-decision-v2-6.js?v=runtime-20260821-r1",
    "aiMiddleRangeDecisionV26",
  );
  loadOnce(
    'script[data-ai-board-intelligence-v2-5]',
    "js/ai-board-intelligence-v2-5.js?v=runtime-20260821-r1",
    "aiBoardIntelligenceV25",
  );
  loadOnce(
    'script[data-ai-repeated-allin-counter]',
    "js/ai-repeated-allin-counter-v1.js?v=runtime-20260821-r1",
    "aiRepeatedAllinCounter",
  );
  loadOnce(
    'script[data-fair-special-bosses]',
    "js/fair-special-bosses.js?v=runtime-20260821-r1",
    "fairSpecialBosses",
  );
  loadOnce(
    'script[data-ai-ev-accounting]',
    "js/ai-ev-accounting-v1.js?v=runtime-20260821-r1",
    "aiEvAccounting",
  );
  loadOnce(
    'script[data-ai-effective-stack-spr]',
    "js/ai-effective-stack-spr-v1.js?v=runtime-20260821-r1",
    "aiEffectiveStackSpr",
  );
  loadOnce(
    'script[data-boss-public-range-model]',
    "js/boss-public-range-model-v1.js?v=runtime-20260821-r1",
    "bossPublicRangeModel",
  );
  loadOnce(
    'script[data-boss-equity-engine]',
    "js/boss-equity-engine-v1.js?v=runtime-20260821-r1",
    "bossEquityEngine",
  );
  loadOnce(
    'script[data-boss-equity-integration]',
    "js/boss-equity-integration-v1.js?v=runtime-20260821-r1",
    "bossEquityIntegration",
  );
  loadOnce(
    'script[data-ai-role-strength-balance]',
    "js/ai-role-strength-balance-v1.js?v=runtime-20260821-r1",
    "aiRoleStrengthBalance",
  );
  loadOnce(
    'script[data-ai-mid-elite-decision-chain-v2-6]',
    "js/ai-mid-elite-decision-chain-v2-5.js?v=runtime-20260821-r1",
    "aiMidEliteDecisionChainV26",
  );
  loadOnce(
    'script[data-tournament-observation-memory]',
    "js/tournament-observation-memory-v1.js?v=runtime-20260821-r1",
    "tournamentObservationMemory",
  );
  loadOnce(
    'script[data-ai-provider-legacy-worker-migration]',
    "js/ai-provider-legacy-worker-migration.js?v=runtime-20260821-r1",
    "aiProviderLegacyWorkerMigration",
  );
  loadOnce(
    'script[data-ai-provider-client]',
    "js/ai-provider-client-v1.js?v=runtime-20260821-r1",
    "aiProviderClient",
  );
  ...
  loadOnce(
    ...
    "js/economy-fold-defense-v1.js?v=runtime-20260821-r1",
    "economyFoldDefenseV1",
  );
  loadOnce(
    'script[data-ai-tiered-multiway-equity-v2-7]',
    "js/ai-tiered-multiway-equity-v2-7.js?v=runtime-20260821-r1",
  ...
  loadOnce(
    ...
    "js/ai-mid-elite-preflop-recovery-v2-9-3.js?v=runtime-20260821-r1",
  ...
  loadOnce(
    ...
    "js/ai-opening-balance-v2-9-4.js?v=runtime-20260821-r1",
  ...
  loadOnce(
    ...
    "js/ai-opening-balance-v2-9-5.js?v=runtime-20260821-r1",
  ...
  loadOnce(
    ...
    "js/ai-action-dispatcher-v1.js?v=runtime-20260821-r1",
